...
canonicalUrl: https://tailwind-nextjs-starter-blog.vercel.app/allposts/new-features-in-v1/
---
...
A demo of a multiple authors post is shown in [Introducing Tailwind Nextjs Starter Blog post](/allposts/introducing-tailwind-nextjs-starter-blog).
